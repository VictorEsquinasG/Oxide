...
mod tests {
    ...
    fn test_connection_quality_levels() {
        assert_eq!(ConnectionQuality::from_latency(5), ConnectionQuality::Excellent);
        ...
        assert_eq!(ConnectionQuality::from_latency(150), ConnectionQuality::Poor);
        assert_eq!(ConnectionQuality::from_latency(300), ConnectionQuality::VeryPoor);
    }
