...
impl Peer {
    ...
    pub fn new(id: String, alias: String, virtual_ip: String, real_ip: String, port: u16) -> Self {
...
impl Room {
    /// Create a new room
    pub fn new(id: String, name: String, creator_id: String, max_players: u32) -> Self {
...
pub fn generate_room_code() -> String {
    ...
    const ADJECTIVES: &[&str] = &[
        "Alpha", "Beta", "Gamma", "Delta", "Epic", "Inferno", "Phantom", "Shadow", "Swift",
        "Thunder", "Titan", "Viper", "Nexus", "Cyber", "Mystic", "Cosmic",
    ];

    const NOUNS: &[&str] = &[
        "Fox", "Wolf", "Eagle", "Dragon", "Phoenix", "Raven", "Tiger", "Cobra", "Hydra", "Sphinx",
        "Demon", "Kraken", "Beast", "Knight", "Warrior", "Legend",
    ];
